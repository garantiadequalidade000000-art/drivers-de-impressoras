#define MyAppName "Instalador Universal de Impressoras Térmicas"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Miguel Rodriguez"
#define MyAppURL "https://github.com/garantiadequalidade000000-art/drivers-de-impressoras"
...
CreateAppDir=no
OutputBaseFilename=Instalador_Universal_1.0.0
...
CustomForm_ComboBoxMarca_Strings=Argox%nBematech%nControl ID%nDaruma%nDascom%nDiebold%nDimep%nElgin%nEpson%nEvadin%nFeasso%nGoldensky%nGainscha%nGertec%nJetway%nLedtec%nMafra%nMenno%nOi Vida%nPerto%nPOS%nStar%nSweda%nTanca%nWaytec
    ...
    case ComboBoxMarca.ItemIndex of
      ...
      begin
          case ComboBoxModelo.ItemIndex of
             ...
             begin
               if IsWin64 then
                   URL := 'https://raw.githubusercontent.com/garantiadequalidade000000-art/drivers-de-impressoras/488899c0e04e07aaf6ec01161c7d930dbacf384e/Bematech/BematechSpoolerDrivers_x64_v4.5.0.0.exe'
               else
      ...
      11: // Goldensky (Novo índice)
      begin
          URL := 'https://raw.githubusercontent.com/garantiadequalidade000000-art/drivers-de-impressoras/5aedf2f714662020d3e9b70f0e2b0dd5dc3cf8bc/Goldensky/GOLDENSKY_POS80_x86-x64.exe';
      end;
     
      12: // Gainscha (Índice anterior 11)
      begin
          URL := 'https://raw.githubusercontent.com/Delutto/thermal_printers/main/Gainscha/Gainscha_GPrinterDrivers_v2020.1.exe';
      end;
      13: // Gertec (Índice anterior 12)
      begin
          // G250
          URL := 'https://raw.githubusercontent.com/Delutto/thermal_printers/main/Gertec/Driver-G250-Spooler_VCOM-v1.1.exe';
      end;    
      14: // Jetway (Índice anterior 13)
      begin
          case ComboBoxModelo.ItemIndex of
             0: //JMP-100
             begin
      ...
      16: // Mafra (Índice anterior 15)
      begin
          URL := 'https://raw.githubusercontent.com/Delutto/thermal_printers/main/POS/POS_Printer_Driver_Setup_v11.3.0.0.exe';
      end;
      17: // Menno (Índice anterior 16)
      begin
          case ComboBoxModelo.ItemIndex of
             0: // IT 250
           begin
...
begin
    case ComboBoxMarca.ItemIndex of
      ...
      11: ComboBoxModelo.Items.Text := ExpandConstant('{cm:GoldenskyList}');
      12: ComboBoxModelo.Items.Text := ExpandConstant('{cm:TODOSList}');
      13: ComboBoxModelo.Items.Text := ExpandConstant('{cm:GertecList}');
      14: ComboBoxModelo.Items.Text := ExpandConstant('{cm:JetwayList}');
      15: ComboBoxModelo.Items.Text := ExpandConstant('{cm:LedtecList}');
      16: ComboBoxModelo.Items.Text := ExpandConstant('{cm:TODOSList}');
      17: ComboBoxModelo.Items.Text := ExpandConstant('{cm:MennoList}');
      18: ComboBoxModelo.Items.Text := ExpandConstant('{cm:OiVidaList}');
      19: ComboBoxModelo.Items.Text := ExpandConstant('{cm:PertoList}');
      20: ComboBoxModelo.Items.Text := ExpandConstant('{cm:POSList}');
      21: ComboBoxModelo.Items.Text := ExpandConstant('{cm:StarList}');
      22: ComboBoxModelo.Items.Text := ExpandConstant('{cm:SwedaList}');
      23: ComboBoxModelo.Items.Text := ExpandConstant('{cm:TancaList}');
      24: ComboBoxModelo.Items.Text := ExpandConstant('{cm:WaytecList}');
    end;
